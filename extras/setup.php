...
function facebook_as_field()
{
    ...
    $options = get_option('facebook_settings');
    ?>
    <input type='text' name='facebook_settings[facebook_app_secret]'
           value='<?php echo $options['facebook_app_secret']; ?>'>
    <?php
...
function facebook_at_field()
{
    ...
    $options = get_option('facebook_settings');
    ?>
    <input type='text' name='facebook_settings[facebook_access_token]'
           value='<?php echo $options['facebook_access_token']; ?>'>
