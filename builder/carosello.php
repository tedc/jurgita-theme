...
<div class="body-container box-carousel" id="row_<?php echo $row; ?>">
    <div class="carousel"<?php if(!is_handheld()) : ?>  data-scrollmagic='{"tween":[{"x" : -50}, {"x" : 0}], "triggerHook" : 0.5, "duration" : 0, "triggerElement": "#row_<?php echo $row; ?>"}'<?php endif; ?>>
        <?php the_sub_field('carousel'); ?>
    </div>
</div>