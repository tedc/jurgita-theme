<div class="container facebook row-lg" id="row_<?php echo $row; ?>">
    <span class="pattern" data-scrollmagic='{"tween":[{"y": -100}, {"y" : 100}], "duration" : "200vh", "triggerHook" : 1, "triggerElement": "#row_<?php echo $row; ?>"}'></span>
    <span class="square" data-scrollmagic='{"tween":[{"y": 100}, {"y" : -100}], "duration" : "200vh", "triggerHook" : 1, "triggerElement": "#row_<?php echo $row; ?>"}'></span>
    <div class="gray-square" data-scrollmagic='{"tween":[{"y": -100}, {"y" : 100}], "duration" : "200vh", "triggerHook" : 1, "triggerElement": "#row_<?php echo $row; ?>"}'></div>
    <div class="like-content">
        ...
        <a href="<?php bloginfo('url'); ?>" class="logo" data-scrollmagic='{"tween":[{"y": "-100%"}, {"y" : "0%"}], "duration" : "200vh", "triggerHook" : 1, "triggerElement": "#row_<?php echo $row; ?>"}'>
            <span class="j">J</span>
            <span class="j">J</span>
        </a>
