<div class="container facebook row-lg" id="row_<?php echo $row; ?>">
    ...
    <div class="like-content">
        ...
        <a class="btn-social" href="<?php echo get_option("wpseo_social")["facebook_site"]?>" target="_blank"  data-scrollmagic='[{"tween":{"opacity" : 0}, "duration" : "100%", "triggerHook" : 1}, {"tween":{"opacity" : 1}, "duration" : "100%", "triggerHook" : 0.75}]'><?php _e('Diventa fan', 'jurgita') ?></a>
    </div>
    <figure data-scrollmagic='[{"tween":{"y": 100}, "duration" : "150vh", "triggerHook" : 1, "reverse" : false}, {"tween":{"y" : -100}, "duration" : "150vh", "triggerHook" : 0, "reverse" : false}]'>
