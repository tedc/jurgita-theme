<div class="container facebook row-lg">
    ...
    <div class="like-content">
        ...
        <p class="title"><span data-scrollmagic='{"tween":{"text":"<?php echo facebook_ratings(); ?>"}, "duration" : 0, "triggerHook" : 0.5}'><?php for($i = 0; $i<strlen(facebook_ratings()); $i++) { echo 0; } ?></span> <?php _e('Like', 'jurgita'); ?></p>
        <span class="like">
