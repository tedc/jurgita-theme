<div class="container facebook row-lg" id="row_<?php echo $row; ?>">
    ...
    <div class="like-content">
        ...
        <a class="btn-social" href="<?php echo get_option("wpseo_social")["facebook_site"]?>" target="_blank"  data-scrollmagic='{"tween":[{"opacity" : 0}, {"opacity" : 1}], "duration" : "100%", "triggerHook" : 1, offset: 50}'><?php _e('Diventa fan', 'jurgita') ?></a>
    </div>
